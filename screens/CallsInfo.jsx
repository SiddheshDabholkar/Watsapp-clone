...
import { Box, VStack, HStack, Center, Avatar, Text, Icon, Divider } from 'native-base';
...
export default function CallsInfo({ navigation, route }) {
    const { callOrVideoCall, received, id, name, time, date, noOfCalls, IncomingOrOutgoing } = route.params;
    useLayoutEffect(() => {
            ...
            headerRight: () => (
                <>
                    <Pressable >
                        <TouchableOpacity>
                            <Box p={2}>
                                <Icon as={<MaterialIcons name="chat" size={24} color="black" />} size="sm" />
                            </Box>
                        </TouchableOpacity>
                    </Pressable>
        ...
        <Box flex={1} bg="#111827" p="4">
            <VStack>
                            ...
                            <HStack>
                                ...
                                <Center w="30%">
                                    <HStack space={8}>
                                        <Pressable>
                                            <TouchableOpacity>
                                                <Icon as={Ionicons} name="md-call" size={4} color="green.500" />
                                            </TouchableOpacity>
                                        </Pressable>
                                        <Pressable>
                                            <TouchableOpacity>
                                                <Icon as={FontAwesome5} name="video" size={4} color="green.500" />
                                            </TouchableOpacity>
                                        </Pressable>
                                    </HStack>
                                </Center>
                ...
                <Center mt={5}>
                    <HStack space={2}>
                        <Center w="15%">
                            <Icon as={Feather} name="arrow-up-right" size={5} color="red.500" />
                        </Center>
                        <Center w="85%">
                            <HStack>
                                <Center w="60%" alignItems="flex-start">
                                    <Text color="#fff" bold>Outgoing</Text>
